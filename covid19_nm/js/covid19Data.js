(function(){
  ...
  d3.csv("data.csv", function(data) {
    var counties = data[0]['cases by county']
    // console.log(counties)
    console.log(JSON.parse(counties)['Bernalillo'])

    // d3.json(counties, function(rec) {
      // console.log(rec)
    // })
    // console.log(Object.keys(counties))
    // counties.keys.forEach(k => console.log(counties[k]))

    var numNodes = 5

  var svg = d3.select('#covid19Data'),
    ...
    var node = svg.append('g')
      ...
      .enter().append("circle")
        ...
        .attr("r", function(d) { return 10 * 3 }) // size of nodes
        .attr("cx", function(d, i) { return 50 + 30 * i })
        .attr("cy", function(d, i) { return 50+30*i })
