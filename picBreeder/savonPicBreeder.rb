...
msg1 = {message: { userName: "", password: "", sid: 1}}
msg2 = {message: { userName: "", password: "", pid: 1}}


client = Savon.client(wsdl: "http://www.picbreeder.org:8080/axis/services/WebNeatClient?wsdl",
                      follow_redirects: true)

response = client.call(:authenticate, message: { userName: "", password: "" })
puts response.

# id_resp = client.call(:get_new_series_id, msg2)

# series_resp = client.call(:get_series_xml, message: { userName: "", password: "", sid: 1})
# puts response.hash
